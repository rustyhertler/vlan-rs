...
Stretch: scripted netns test harness in CI ✅, `cargo-fuzz` on the parser ✅, MAC aging ✅, loop guard ✅ — see `docs/stretch-goals.md`. Unscheduled: QinQ, small web dashboard.
